...
interface AppDao {
    ...
    // Update payment details when user pays online
    @Query("UPDATE appointments SET paymentStatus = :newPaymentStatus, paymentMode = :newPaymentMode WHERE id = :appointmentId")
    suspend fun updatePaymentDetails(appointmentId: Int, newPaymentStatus: String, newPaymentMode: String)
}
