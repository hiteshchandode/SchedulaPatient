    ...
    Scaffold(
        ...
        Column(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Text(
                        text = buildAnnotatedString {
                            ...
                            append(". Since you paid the consultation fee, the refund will be processed within ")
                            withStyle(style = SpanStyle(fontWeight = FontWeight.Bold)) { append("2 working days") }
                            append(". We sincerely apologize for the inconvenience.")
                        },
                        fontSize = 13.sp,
            ...
            Card(
                modifier = Modifier
                    .fillMaxWidth()
                    .clickable { navController.navigate("payments") },
                shape = RoundedCornerShape(16.dp),
                ...
                Row(modifier = Modifier.padding(16.dp)) {
                    ...
                    Column(modifier = Modifier.fillMaxWidth()) {
                        ...
                        Text("Estimated refund within 2 working days (Tap to view)", fontSize = 12.sp, color = Color(0xFF15803D))
            ...
            // --- 5. RESCHEDULE BUTTON ---
            Button(
                onClick = { navController.navigate("booking_step2") },
                modifier = Modifier
                    .fillMaxWidth()
                    .height(50.dp),
